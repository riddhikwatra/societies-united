<div class="header">
    ...
    <div class="navbar hidden" id="navbar">
        ...
        <div id="parent-div" class="sub-navbar hidden">
            ...
            ?>
            <a href="society.php?soc=<?php echo $row['soc_name'] ?>" class=<?php echo $soc_name==$row['soc_name'] ? "active":""?>  >
                <div class="nav-item">    
                    <?php echo $row['soc_name'] ?>
                </div>
            </a>
            <hr>
            <?php
    ...
    <div class="admin-options hidden" id="admin-options">
        ...
        ?>
            <ul>
                <a href="../admin/form.php"><li>Add New Event</li></a>
                <hr>
                <a href="../admin/admin_add_report.php"><li>Add Event Report</li></a>
                <hr>
                <a href="../admin/admin_edit_team.php"><li>Edit Society Team</li></a>
                <hr>
                <a href="../admin/logout.php"><li>Logout</li></a>
            </ul>
        <?php
        }
        else{
        ?>
            <ul>
                <a href="login.php"><li>Admin Log In</li></a>
            </ul>
        <?php
        }
        ?>
